...
import panda.domain.models.bindingModels.UserRegisterBindingModel;
...
public class UserRegisterBean {
    ...
    public void register() throws IOException {
        ...
        if (!this.userRegisterBindingModel.getPassword().equals(this.userRegisterBindingModel.getConfirmPassword())){
            FacesContext.getCurrentInstance().getExternalContext().redirect("/faces/view/register.xhtml");
            return;
        }
