...
public class PendingPackagesBean {
    ...
    private void initPackages() {
        this.packageViewModels = this.packageService.findAllByStatus(Status.Pending).stream()
        .map(p -> {
    ...
    public void changeStatus(String id) throws IOException {
        ...
        FacesContext.getCurrentInstance().getExternalContext().redirect("/faces/view/packages/pending.xhtml");
    }
}
